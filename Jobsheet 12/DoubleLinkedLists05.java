public class DoubleLinkedLists05 {
    ...
    public DoubleLinkedLists05() {
        ...
        public void addFirst (int item) {
            if (isEmpty()) {
                head = new Node05(null, item, null);
            }else {
                Node05 newNode05 = new Node05(null, item, head);
                head.prev = newNode05;
                head = newNode05;
            }
            size++;
            ...
            public void addLast (int item) {
                if (isEmpty()) {
                    ...
                    Node05 newNode05 = new Node05(current, item, null);
            ...
            public void add (int item, int index) throws Exception {
                if (isEmpty()) {
                    ...
                    if (current.prev == null) {
                        Node05 newNode05 = new Node05(null, item, current);
